...
/***/ function(module, exports, __webpack_require__) {
	...
	ProjectResource.prototype.request = function (actionName, options) {
	    ...
	    if (actionName === 'fetch' && options.session && options.project_id === undefined) {
	        ...
	        result = $resource(url, options, method);
	    } else if (actionName === 'update' && options.session && options.Project && options.Project.title && options.Project.id) {
	        options = {
	            'session': options.session,
	            'Project': {
	        ...
	        result = $resource(url, options, method);
	    } else if (actionName === 'create' && options.session && options.Project && options.Project.title) {
	        options = {
	            'session': options.session,
	            'Project': {
	                'title': options.Project.title
...
/***/ function(module, exports, __webpack_require__) {
	...
	TaskResource.prototype.request = function (actionName, options) {
	    ...
	    if (actionName === 'fetch' && options.session && options.project_id && options.paging_size && options.paging_offset) {
	        ...
	        result = $resource(url, options, method);
	    } else if (actionName === 'create' && options.session && options.Project && options.Project.id && options.Task && options.Task.title) {
	        options = {
	            'session': options.session,
	            'Project': {
	                'id': options.Project.id
